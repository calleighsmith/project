...
labels <- c("Intercept", "Beach Length (mi)", "Water Body (Great Lakes)", "Water Body (Gulf of Mexico)",
                  "Water Body (Long Island Sound)", "Water Body (Pacific Ocean)", "Beach Owner (Public)", "Swim Season (day)", "Intercept", "Beach Length (mi)", "Water Body (Great Lakes)", "Water Body (Gulf of Mexico)",
